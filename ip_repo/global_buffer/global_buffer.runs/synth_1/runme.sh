...
HD_PWD='C:/Users/user/Desktop/FPGA/term_project/FPGA-Project-2022-simple-tpu/global_buffer/global_buffer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log global_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source global_buffer.tcl
